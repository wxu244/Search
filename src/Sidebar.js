...
class Sidebar extends React.Component {
  ...
  render() {
    return (
      <Card className="sidebar" style={{ backgroundColor:"lightblue", color:"white", fontSize:30,}}>
        <Card.Body>
          <Card.Title style={{ fontSize:40}}>Search and Filter</Card.Title>
          <Form>
            <Form.Group
            ...
            >
              <Form.Label style={{ fontSize:25, }}>Search</Form.Label>
              <Form.Control
                type="text"
                placeholder="Search"
                autoComplete="off"
            ...
            <Form.Group controlId="formSubject" className="mb-3">
                <Form.Label style={{ fontSize:25, }}>Subject</Form.Label>
                <Form.Select ref={this.subject} onChange={() => this.setCourses()}>
                  {this.getSubjectOptions()}
                </Form.Select>
              </Form.Group>

            <Form.Label style={{ fontSize:25, }}>Credits</Form.Label>
            <div
              className="mb-3"
              style={{
                display: "flex",
